...
async function noprefix(arg) {
    ...
    for (const el of arr) {
        ...
        if (regEx_facebook.test(el)) {
            let res = (await axios.get('http://158.101.198.227:8145/api/facebook/v1?link={url}&token=EAAD6V7os0gcBO8PNtsKFtSv6WBoQQszk1ZC6W8ZBXLVVqjFOFJaCGfscRh24RhDpKUmLC5AE3zfv6ZCmkJ9XJkRCkaKdoAP2BSJDGgzmRnWwMhAal6UQZALG9gEZAwblEt5WZBCcp8ZBhfW2O7OsQx5cybGRfc7CnA8WKn3gAYSHlamjNvGEVpVlvybZAwZDZD)).data;
